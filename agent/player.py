...
class GoaliePlayer:
    ...
    def act(self, image, player_info):
        ...
        puck_x = puck_loc[0]
        puck_y = puck_loc[1]
        puck_not_on_screen = (puck_y > 200 and puck_x >= 150 and puck_x <= 250)
        ...
        if(puck_not_on_screen or too_far):
            ...
            # print("signed theta: ", np.degrees(signed_theta))
        ...
        if player_info.kart.id == 0:
            ...
            PREV_DRAW2 = plt.Circle((puck_x, puck_y), 10, ec='r', fill=False, lw=1.5)
            ax1.add_artist(PREV_DRAW)
            ax1.add_artist(PREV_DRAW2)
